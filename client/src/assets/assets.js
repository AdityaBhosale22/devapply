...
import {
    SquarePen, Hash, Image, Eraser, Scissors, FileText, Briefcase,
    Target,
    Code,
    PenTool,
    LayoutDashboard
...
export const AiToolsData = [
    {
        ...
        description: 'Upload your resume (PDF) to get ATS scoring, gap analysis, and keyword improvements.',
        Icon: FileText,
        bg: { from: '#4F46E5', to: '#4338CA' }, // Indigo (Professional)
        path: '/app/resumeanalyzer'
    },
    {
        title: 'Cover Letter Generator',
        description: 'Paste a job description to generate a tailored, persuasive cover letter in seconds.',
        Icon: PenTool,
        bg: { from: '#9333EA', to: '#7E22CE' }, // Purple (Creative)
        path: '/app/coverlettergenerator'
    },
    {
        title: 'Job Fit Scorer',
        description: 'Analyze how well your current profile matches a specific job description.',
        Icon: Target,
        bg: { from: '#059669', to: '#047857' }, // Green (Success/Target)
        path: '/app/jobfitanalyzer'
    },
    {
        title: 'Project Bullet Enhancer',
        description: 'Turn your GitHub project descriptions into punchy, metric-driven resume bullet points.',
        Icon: Code,
        bg: { from: '#EA580C', to: '#C2410C' }, // Orange (Technical)
        path: '/app/projectbulletgenerator'
    },
    // Optional: Placeholder for future features to make the grid look full
    {
        title: 'Interview Prep (Coming Soon)',
        description: 'Practice with AI-generated questions specific to your tech stack.',
        Icon: Briefcase,
        bg: { from: '#52525B', to: '#3F3F46' }, // Gray (Inactive/Future)
        path: '#'
    }
];
